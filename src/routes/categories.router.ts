import { readRealEstateCategoryController } from "../controllers/readRealEstateCategory.controller"
...
categoryRouter.get('/:id/realEstate', checkIfCategoryExist, readRealEstateCategoryController)